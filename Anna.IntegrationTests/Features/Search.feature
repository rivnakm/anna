Feature: Package search
    ...
    Scenario: Search with an empty query
        ...
        Then the search results should contain 2 items and 2 total hits
    ...
    Scenario: Search with a query matching a package name
        ...
        Then the search results should contain 1 item and 1 total hit
    ...
    Scenario: Search with prereleases included
        ...
        And I set the search to include prereleases
